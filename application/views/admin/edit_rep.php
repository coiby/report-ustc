...
<script>
	...
	$(function() {
        ...
        var dataString = 'action=update-rep&' +'id='+id +'&title='+title +'&speaker='+speaker+'&place='+place+'&institution='+insti +'&profile='+profile + '&date='+date +'&begin='+begin+'&end='+end+'&content='+content;
        if(senttobbs){
		...
		$.ajax({
			...
			success : function(data) {
				 ...
				 $('tr#'+data.id).replaceWith(trhtml);
				 $('tr#'+data.id).hide().fadeIn(500);
	...
	<div class="container">
		<form class="form-horizontal">
		    <input type="hidden" value="<?php echo $report['id'] ?>" name="id" id="id">
			<div class="control-group">
				 <div class="span10">
				<label for="title" class="control-label">报告题目</label>
				<div class="controls" >
					<input type="text" class="input-xxlarge" name="title" id="title" value="<?php echo $report['title'] ?>">
				</div>
			</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls" >
					<input type="text" name="speaker" id="speaker" class="input-large" value="<?php echo $report['speaker'] ?>">
				</div>
				</div>
				<div class="span4">
				<label for="insti" class="control-label">单位</label>
				<div class="controls" >
					<input type="text" name="insti" id="insti" class="input-xlarge" value="<?php echo $report['institution'] ?>">
				</div>
				</div>
			...
			<div class="control-group">
				...
				<div class="controls" >
					<textarea name="profile" id="profile" class="span4"><?php echo $report['profile'] ?></textarea>
				</div>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls date form_date" data-date="<?php echo $report['date'] ?>" data-date-format="yyyy-mm-dd" >
					<input type="text" name="date" id="date" value="<?php echo $report['date'] ?>">
			...
			<div class="control-group">
				...
				<div class="controls date form_time" data-date="<?php echo $report['starttime'] ?>" data-date-format="hh:ii">
					<input type="text" name="begin" id="begin" value="<?php echo $report['starttime'] ?>">
					<span class="add-on"><i class="icon-remove"></i></span>
					<span class="add-on"><i class="icon-th"></i></span>
				</div>
				</div>
				...
				<div class="controls date form_time" data-date="<?php echo $report['endtime'] ?>" data-date-format="hh:ii">
					<input type="text" name="end" id="end" value="<?php echo $report['endtime'] ?>">
					<span class="add-on"><i class="icon-remove"></i></span>
					<span class="add-on"><i class="icon-th"></i></span>
				</div>
			...
			<div class="control-group">
				...
				<div class="controls" >
					<input type="text" class="input-xxlarge" name="place" id="place" value="<?php echo $report['place'] ?>" >
				</div>
			</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea name="content" id="content" cols="70" rows="12" class="span8" placeholder="请填写报告内容" ><?php echo $report['content'] ?></textarea>
				</div>
			</div>
			</div>
			...
			<!-- <div class="control-group">
				<div class="span2">
					<label for="senttobbs" class="control-label">更新BBS</label>
					<div class="controls">
			...
			<div class="control-group">
				<div class="span10">
				 <label class="control-label" for="button1id"></label>
  				 <div class="controls">
   					 <button id="button1id" name="button1id" class="btn btn-success">修改报告</button>
 				 </div>
			 </div>
			</div>
		</form>
